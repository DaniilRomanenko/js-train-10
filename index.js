...
function customAssign(...objects) {
  // Перевірка, чи передано достатньо об'єктів
  if (objects.length < 2) {
 ...
 * Повертає - Об'єкт, створений з записів з обробленими значеннями.
 */
...
function checkProperty(obj, prop) {
  ...
  if (typeof prop !== 'string') {
    return "Помилка: Властивість має бути рядком.";
  }
...
function filterObjectsByKey(arr, key) {
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо пустий маси
...
function checkAndPreventExtensions(obj) {
  ...
  // Повертаємо результат (true, якщо об'єкт був розширюваним, false, якщо не був)
  return isExtensibleBefore;
}
